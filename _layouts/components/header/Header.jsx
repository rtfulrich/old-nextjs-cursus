  ...
  return (
    <header className={`h-12 flex items-center justify-between text-white pr-2 md:pr-4 fixed top-0 w-full bg33`}>
      <div className="flex h-full items-center">
        <div className="bg-red-500 hover:bg-red-600 cursor-pointer h-full w-12 flex justify-center items-center transition-colors duration-200 ease-in-out" onClick={toggleSidebar}>
